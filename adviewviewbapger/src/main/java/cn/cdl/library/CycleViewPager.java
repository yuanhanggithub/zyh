...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(getActivity()).inflate(
                R.layout.view_recycle_content, null);
    ...
    public void setData(List<ImageView> views, List<String> list,
        ...
        for (int i = 0; i < indicators.length; i++) {
            View view = LayoutInflater.from(getActivity()).inflate(
                    R.layout.view_recycle_indicator, null);
    ...
    public void onPageSelected(int arg0) {
        mImageCycleViewListener.onItemSecet(arg0);
        int max = imageViews.size() - 1;
        int position = arg0;
    ...
    private void setIndicator(int selectedPosition) {
        ...
        if (indicators.length - 1 > selectedPosition)
    ...
    public interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        void onImageClick(String info, int postion, View imageView);

        void onItemSecet(int position);
